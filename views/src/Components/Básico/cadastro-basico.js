        ...
        <div><div className="fill-box">
            <form id="survey-form">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="fullName" value={candidate.fullName} onChange={handleInputChange} id="fullName" class="survey-control" required />
                </div>
                {/* Nome Social */}
                <div class="survey-box">
                    <label for="socialName" id="socialName-label">Nome Social:</label>
                    <br />
                    <input type="text" name="socialName" value={candidate.socialName} onChange={handleInputChange} id="socialName" class="survey-control" />
                </div>
                {/* Data de Nascimento */}
                <div class="survey-box">
                    <label for="birthDate" id="birthDate-label">Data de Nascimento:</label>
                    <br />
                    <input type="date" name="birthDate" value={candidate.birthDate} onChange={handleInputChange} id="birthDate" class="survey-control" required />
                </div>
                {/* Sexo */}
                <div class="survey-box">
                    <label for="gender" id="gender-label">Sexo:</label>
                    <br />
                    <select name="gender" id="gender" value={candidate.gender} onChange={handleInputChange} class="select-data" required>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="nationality" onChange={handleInputChange} value={candidate.nationality} id="nationality" class="survey-control" required />
                </div>
                {/* Cidade de Nascimento */}
                <div class="survey-box">
                    <label for="natural_city" id="natural_city-label">Cidade Natal:</label>
                    <br />
                    <input type="text" name="natural_city" value={candidate.natural_city} onChange={handleInputChange} id="natural_city" class="survey-control" required />
                </div>
                {/* Estado de nascimento */}
                <div class="survey-box">
                    <label for="natural_UF" id="natural_UF-label">Unidade Federativa:</label>
                    <br />
                    <select name="natural_UF" onChange={handleInputChange} value={candidate.natural_UF} id="natural_UF" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="RG" value={candidate.RG} onChange={handleInputChange} id="RG" class="survey-control" required />
                </div>
                {/* Orgão Emissor do RG */}
                <div class="survey-box">
                    <label for="rgIssuingAuthority" id="rgIssuingAuthority-label">Órgão Emissor do RG:</label>
                    <br />
                    <input type="text" name="rgIssuingAuthority" value={candidate.rgIssuingAuthority} onChange={handleInputChange} id="rgIssuingAuthority" class="survey-control" required />
                </div>
                {/* Estado do RG emitido */}
                <div class="survey-box">
                    <label for="rgIssuingState" id="rgIssuingState-label">Estado do Órgão Emissor do RG:</label>
                    <br />
                    <select name="rgIssuingState" value={candidate.rgIssuingState} onChange={handleInputChange} id="rgIssuingState" class="select-data">
                ...
                {!candidate.RG && <div>
                  {/* Tipo do documento adicional */}
                    <div class="survey-box">
                        ...
                        <br />
                        <select name="documentType" onChange={handleInputChange} value={candidate.documentType} id="documentType" class="select-data">
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="documentNumber" value={candidate.documentNumber} onChange={handleInputChange} id="documentNumber" class="survey-control" />
                    </div>
                    {/* Validade do documento adicional */}
                    <div class="survey-box">
                        <label for="documentValidity" id="documentValidity-label">Data de Validade:</label>
                        <br />
                        <input type="date" name="documentValidity" value={candidate.documentValidity} onChange={handleInputChange} id="documentValidity" class="survey-control" />
                    </div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="numberOfBirthRegister" onChange={handleInputChange} value={candidate.numberOfBirthRegister} id="numberOfBirthRegister" class="survey-control" required />
                    </div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="bookOfBirthRegister" onChange={handleInputChange} value={candidate.bookOfBirthRegister} id="bookOfBirthRegister" class="survey-control" required />
                    </div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="pageOfBirthRegister" onChange={handleInputChange} value={candidate.pageOfBirthRegister} id="pageOfBirthRegister" class="survey-control" required />
                    </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <select name="maritalStatus" value={candidate.maritalStatus} onChange={handleInputChange} id="maritalStatus" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <select name="skinColor" onChange={handleInputChange} value={candidate.skinColor} id="skinColor" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <select name="religion" value={candidate.religion} onChange={handleInputChange} id="religion" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <select name="educationLevel" onChange={handleInputChange} value={candidate.educationLevel} id="educationLevel" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="specialNeeds" onChange={handleInputChange} value={candidate.specialNeeds} id="specialNeeds" class="survey-control" />
                </div>
                {candidate.specialNeeds && <div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="specialNeedsDescription" onChange={handleInputChange} value={candidate.specialNeedsDescription} id="specialNeedsDescription" class="survey-control" />
                    </div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="checkbox" name="hasMedicalReport" onChange={handleInputChange} value={candidate.hasMedicalReport} id="hasMedicalReport" class="survey-control" />
                    </div>
                </div>}
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="landlinePhone" onChange={handleInputChange} value={candidate.landlinePhone} id="landlinePhone" class="survey-control" />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="workPhone" onChange={handleInputChange} value={candidate.workPhone} id="workPhone" class="survey-control" />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="contactNameForMessage" onChange={handleInputChange} value={candidate.contactNameForMessage} id="contactNameForMessage" class="survey-control" />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="profession" value={candidate.profession} onChange={handleInputChange} id="profession" class="survey-control" required />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="enrolledGovernmentProgram" value={candidate.enrolledGovernmentProgram} onChange={handleInputChange} id="enrolledGovernmentProgram" class="survey-control" />
                </div>
                ...
                {candidate.enrolledGovernmentProgram === true && <div>
                    ...
                    <div class="survey-box">
                        ...
                        <br />
                        <input type="text" name="NIS" value={candidate.NIS} onChange={handleInputChange} id="NIS" class="survey-control" />
                    </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <select name="incomeSource" multiple onChange={handleInputChange} value={candidate.incomeSource} id="incomeSource" class="select-data">
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="intendsToGetScholarship" value={candidate.intendsToGetScholarship} onChange={handleInputChange} id="intendsToGetScholarship" class="survey-control" />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="attendedPublicHighSchool" value={candidate.attendedPublicHighSchool} onChange={handleInputChange} id="attendedPublicHighSchool" class="survey-control" required />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="benefitedFromCebasScholarship_basic" value={candidate.benefitedFromCebasScholarship_basic} onChange={handleInputChange} id="benefitedFromCebasScholarship_basic" class="survey-control" required />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="yearsBenefitedFromCebas_basic" value={candidate.yearsBenefitedFromCebas_basic} onChange={handleInputChange} id="yearsBenefitedFromCebas_basic" class="survey-control" />
                </div>
                  {/*<!-- Tipo de Escolaridade (Básica) -->*/}
                <div class="survey-box">
                <label for="scholarshipType_basic" id="scholarshipType_basic-label">Tipo de Educação Básica:</label>
                    <br />
                    <select name="scholarshipType_basic" onChange={handleInputChange} value={candidate.scholarshipType_basic} id="scholarshipType_basic" class="select-data">
                 ...
                 <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="institutionName_basic" value={candidate.institutionName_basic} onChange={handleInputChange} id="institutionName_basic" class="survey-control" required />
                </div>
                 ...
                 <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="institutionCNPJ_basic" value={candidate.institutionCNPJ_basic} onChange={handleInputChange} id="institutionCNPJ_basic" class="survey-control" required />
                </div>
                </div>
                }
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="checkbox" name="benefitedFromCebasScholarship_professional" value={candidate.benefitedFromCebasScholarship_professional} onChange={handleInputChange} id="benefitedFromCebasScholarship_basic" class="survey-control" required />
                </div>
                {candidate.benefitedFromCebasScholarship_professional && <div>
                  <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="lastYearBenefitedFromCebas_professional" value={candidate.lastYearBenefitedFromCebas_professional} onChange={handleInputChange} id="lastYearBenefitedFromCebas_professional" class="survey-control" />
                  </div>
                ...
                <label for="scholarshipType_professional" id="scholarshipType_professional-label">Tipo de Educação Profissional:</label>
                    <br />
                    <select name="scholarshipType_professional" onChange={handleInputChange} value={candidate.scholarshipType_professional} id="scholarshipType_basic" class="select-data">
                        {ScholarshipType.map((type) => <option value={type.value}>{type.label}</option>)}
                    </select>
                </div>
                 ...
                 <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="institutionName_professional" value={candidate.institutionName_professional} onChange={handleInputChange} id="institutionName_professional" class="survey-control" required />
                </div>
                 ...
                 <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="institutionCNPJ_professional" value={candidate.institutionCNPJ_professional} onChange={handleInputChange} id="institutionCNPJ_professional" class="survey-control" required />
                </div>
                ...
                <div class="survey-box">
                    ...
                    <br />
                    <input type="text" name="nameOfScholarshipCourse_professional" value={candidate.nameOfScholarshipCourse_professional} onChange={handleInputChange} id="nameOfScholarshipCourse_professional" class="survey-control" required />
                </div>
                </div>
