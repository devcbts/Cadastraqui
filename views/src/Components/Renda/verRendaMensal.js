...
export const VerRendaMensal = ({ incomeSource, monthlyIncomesByType, id, role }) => {
    ...
    const updateIncomeInfo = (monthlyIncomes) => {
        const updatedIncomeInfo = monthlyIncomes.reduce((acc, income, index) => {
            ...
            acc[`transportAllowanceValue${num}`] = income.transportAllowanceValue || 0;
            acc[`expenseReimbursementValue${num}`] = income.expenseReimbursementValue || 0;
        ...
        setIncomeInfo(prev => ({ ...prev, ...updatedIncomeInfo, quantity: monthlyIncomes.length }));
    };
    ...
    async function handleRegisterIncome(e) {
        ...
        try {
            const response = await api.post(`/candidates/family-member/income/${id}`, data, {
                headers: {
    ...
    return (
        <div><div className="fill-box">
            <form id="survey-form">
                ...
                {incomeSource.includes('Unemployed') &&
                    (<>
                        ...
                        <div class="survey-box">
                            ...
                            <input type="checkbox"
                                disabled={!isEditing}
                                name="receivesUnemployment" value={unemployedInfo.receivesUnemployment} onChange={handleReceivesUnemployment} id="receivesUnemployment" class="survey-control" />
                        </div>
                        {receivesUnemployment && (
                            <>
                                ...
                                <div class="survey-box">
                                    ...
                                    <input type="number"
                                        disabled={!isEditing}
                                        name="parcels" value={unemployedInfo.parcels} id="parcels" class="survey-control" />
                                </div>
                                ...
                                <div class="survey-box">
                                    ...
                                    <input type="date"
                                        disabled={!isEditing}
                                        name="firstParcelDate" value={unemployedInfo.firstParcelDate} onChange={handleInputUnemployedChange} id="firstParcelDate" class="survey-control" />
                                </div>
                                {/*<!-- Valor da Parcela -->*/}
                                <div class="survey-box">
                                    ...
                                    <input type="number"
                                        disabled={!isEditing}
                                        name="parcelValue" value={unemployedInfo.parcelValue} onChange={handleInputUnemployedChange} id="parcelValue" class="survey-control" />
                                </div>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="fixIncome" value={fixIncomeAutonomous} onChange={handleFixIncomeAutonomous} id="fixIncome" class="survey-control" />
                            </div>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="fixIncome" value={fixIncomeInformalWorker} onChange={handleFixIncomeInformalWorker} id="fixIncome" class="survey-control" />
                            </div>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="fixIncome" value={fixIncomeRentalIncome} onChange={handleFixIncomeRentalIncome} id="fixIncome" class="survey-control" />
                            </div>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="fixIncome" value={fixIncomeLiberalProfessional} onChange={handleFixIncomeLiberalProfessional} id="fixIncome" class="survey-control" />
                            </div>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="fixIncome" value={fixIncomePrivatePension} onChange={handleFixIncomePrivatePension} id="fixIncome" class="survey-control" />
                            </div>
                ...
                {/* Empresário */}
                {incomeSource.includes('BusinessOwner') && incomeSource.includes('BusinessOwnerSimplifiedTax')
                    (
                        <>
                            {/*<!-- Data de Início -->*/}
                            <div class="survey-box">
                                ...
                                <input type="date"
                                    disabled={!isEditing}
                                    name="startDate" value={entepreneurInfo.startDate} onChange={handleEntepreneurInputChange} id="startDate" class="survey-control" />
                            </div>
                            {/*<!-- Razao Social -->*/}
                            <div class="survey-box">
                                ...
                                <input type="text"
                                    disabled={!isEditing}
                                    name="socialReason" value={entepreneurInfo.socialReason} onChange={handleEntepreneurInputChange} id="socialReason" class="survey-control" />
                            </div>
                            {/*<!-- Nome Fantasia -->*/}
                            <div class="survey-box">
                                ...
                                <input type="text"
                                    disabled={!isEditing}
                                    name="fantasyName" value={entepreneurInfo.fantasyName} onChange={handleEntepreneurInputChange} id="fantasyName" class="survey-control" />
                            </div>
                            {/*<!-- CNPJ -->*/}
                            <div class="survey-box">
                                ...
                                <input type="text"
                                    disabled={!isEditing}
                                    name="CNPJ" value={entepreneurInfo.CNPJ} onChange={handleEntepreneurInputChange} id="CNPJ" class="survey-control" />
                            </div>
                            <div>
                                {Array.from({ length: 6 }).map((_, i) => (
                                    <>
                    ...
                    (
                        <>
                            ...
                            <div class="survey-box">
                                ...
                                <input type="checkbox"
                                    disabled={!isEditing}
                                    name="gratification" value={gratificationAutonomous} onChange={handleGratificationAutonomous} id="gratification" class="survey-control" />
                            </div>
                                        ...
                                        {Array.from({ length: 6 }).map((_, i) => (
                                            <>
                                                ...
                                                <div class="survey-box" key={`deductions-${i + 1}`}>
                                                    ...
                                                    <input type="checkbox"
                                                        disabled={!isEditing}
                                                        name="deductions" value={deductionsCLT[i + 1]} onChange={() => handleDeductionsCLT(i + 1)} id="deductions" class="survey-control" />
                                                </div>
                ...
                {role !== 'Assistant'}{
                    ...
                    <div>
                        ...
                        {!isEditing ? (
                            ...
                            <>
                                <button type="button" className="over-button" onClick={handleRegisterIncome}>Salvar Dados</button>
