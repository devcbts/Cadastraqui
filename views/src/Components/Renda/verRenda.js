...
export const VerRenda = ({ member }) => {
  ...
  const [financialHelpFromOthersInfo, setFinancialHelpFromOthersInfo] =
    useState({
      averageIncome: "0.0",
  ...
  const [temporaryDisabilityBenefitInfo, setTemporaryDisabilityBenefitInfo] =
    useState({
      averageIncome: "0.0",
      admissionDate: "",
      position: "",
        ...
        <form id="survey-form">
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="date"
                  name="startDate"
                  value={loading ? "" : MEIInfo.startDate.split("T")[0]}
                  id="startDate"
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={loading ? false : unemployedInfo.receivesUnemployment}
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="number"
                  name="parcels"
                  value={loading ? "" : unemployedInfo.parcels}
                  id="parcels"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading ? "" : unemployedInfo.firstParcelDate.split("T")[0]
                  }
                  id="firstParcelDate"
                  class="survey-control"
                />
          ...
          {member.incomeSource.includes("FinancialHelpFromOthers") && (
            <>
              ...
              <div class="survey-box">
                <label
                  for="financialAssistantCPF"
                  id="financialAssistantCPF-label"
                >
                  CPF do Assistente Financeiro
                </label>
                <br />
                <input
                  disabled
                  ...
                  value={
                    loading
                      ? ""
                      : financialHelpFromOthersInfo.financialAssistantCPF
                  }
                  id="averageIncome"
                  class="survey-control"
                />
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading
                      ? ""
                      : privateEmployeeInfo.admissionDate?.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : privateEmployeeInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : privateEmployeeInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={loading ? "" : privateEmployeeInfo.payingSourcePhone}
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading
                      ? ""
                      : publicEmployeeInfo.admissionDate.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : publicEmployeeInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : publicEmployeeInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSourcePhone"
                  value={loading ? "" : publicEmployeeInfo.payingSourcePhone}
                  id="payingSourcePhone"
                  class="survey-control"
                />
              </div>
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading
                      ? ""
                      : domesticEmployeeInfo.admissionDate.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : domesticEmployeeInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : domesticEmployeeInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSourcePhone"
                  value={loading ? "" : domesticEmployeeInfo.payingSourcePhone}
                  id="payingSourcePhone"
                  class="survey-control"
                />
              </div>
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading
                      ? ""
                      : temporaryRuralEmployeeInfo.admissionDate.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : temporaryRuralEmployeeInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : temporaryRuralEmployeeInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  name="payingSourcePhone"
                  value={
                    loading ? "" : temporaryRuralEmployeeInfo.payingSourcePhone
                  }
                  id="payingSourcePhone"
                  class="survey-control"
                />
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="date"
                  name="admissionDate"
                  value={loading ? "" : retiredInfo.admissionDate.split("T")[0]}
                  id="admissionDate"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : retiredInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : retiredInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSourcePhone"
                  value={loading ? "" : retiredInfo.payingSourcePhone}
                  id="payingSourcePhone"
                  class="survey-control"
                />
              </div>
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  name="admissionDate"
                  value={
                    loading ? "" : pensionerInfo.admissionDate.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : pensionerInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : pensionerInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSourcePhone"
                  value={loading ? "" : pensionerInfo.payingSourcePhone}
                  id="payingSourcePhone"
                  class="survey-control"
                />
              </div>
          ...
          {member.incomeSource.includes("TemporaryDisabilityBenefit") && (
            <>
              <h4>
                Fonte de renda: benefício por Incapacidade Temporária
                (Auxílio-doença)
              </h4>
              {/*<!-- Data de Admissão -->*/}
              <div class="survey-box">
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : temporaryDisabilityBenefitInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  name="payingSource"
                  value={
                    loading ? "" : temporaryDisabilityBenefitInfo.payingSource
                  }
                  id="payingSource"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  value={
                    loading
                      ? ""
                      : temporaryDisabilityBenefitInfo.payingSourcePhone
                  }
                  id="payingSourcePhone"
                  class="survey-control"
                />
            ...
            <>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  name="admissionDate"
                  value={
                    loading ? "" : apprenticeInfo.admissionDate.split("T")[0]
                  }
                  id="admissionDate"
                  class="survey-control"
                />
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="position"
                  value={loading ? "" : apprenticeInfo.position}
                  id="position"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSource"
                  value={loading ? "" : apprenticeInfo.payingSource}
                  id="payingSource"
                  class="survey-control"
                />
              </div>
              ...
              <div class="survey-box">
                ...
                <input
                  ...
                  type="text"
                  name="payingSourcePhone"
                  value={loading ? "" : apprenticeInfo.payingSourcePhone}
                  id="payingSourcePhone"
                  class="survey-control"
                />
              </div>
