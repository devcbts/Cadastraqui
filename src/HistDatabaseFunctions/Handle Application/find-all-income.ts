...
export default async function findAllIncome(candidate_id: string | null, legalResponsibleId: string | null) {
    ...
    const income = await prisma.familyMemberIncome.findMany({
        where: {
            OR: [
