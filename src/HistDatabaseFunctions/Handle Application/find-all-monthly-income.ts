...
export default async function findAllMonthlyIncome(candidate_id: string | null, legalResponsibleId: string | null) {
    ...
    const monthlyIncome = await prisma.monthlyIncome.findMany({
        where: {
            OR: [
