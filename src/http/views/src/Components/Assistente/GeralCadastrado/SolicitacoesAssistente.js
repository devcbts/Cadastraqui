...
export default function SolicitacoesAssistente({application_id, announcement_id}) {
  ...
  return (
    <div className="fill-container general-info">
      ...
      <div className="comments-box">
        <VerSolicitacoesAssistente application_id={application_id} announcement_id={announcement_id}/>
      </div>
    </div>
  )
}
