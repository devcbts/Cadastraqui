    ...
    try {
        ...
        if (format == 'PDF') {
            ...
            const scholarshipsInfos = scholarships.map((scholarship) => {
                return {
                    educationalCENSUSInstitutionCode: (scholarship.application.EducationLevel.entitySubsidiary ? scholarship.application.EducationLevel.entitySubsidiary : scholarship.application.announcement.entity.educationalInstitutionCode), 
                    ...
                    partiaPercentage:  scholarship.application.ScholarshipPartial ? "50%" : "100%",
