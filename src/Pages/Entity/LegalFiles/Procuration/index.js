    ...
    return (
        <>
            ...
            <div style={{ width: 'max(280px,60%)', display: 'flex', margin: 'auto', flexDirection: 'column', alignItems: 'self-start' }}>
                <InputForm type="date" control={control} label={'Data da nomeação e constituição por bastente procurador(a)'} name={'issuedAt'} />
                <InputForm type="date" control={control} label={'validade da procuração'} name={'expireAt'} />
