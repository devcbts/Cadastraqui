...
export default function StartSubscription() {
    const { move } = useContext(AnnouncementContext)
    return (
        <>
            ...
            <div className={styles.content}>
                <div>
                    <div>
                        <h2>Compromisso em comunicar eventual alteração no tamanho do grupo familiar e/ou renda</h2>
                        <span>
                    ...
                    <div>
                        <h2>Inteira responsabilidade pelas informações contidas neste cadastro</h2>
                        <span>
