...
export default function TypeTwoResponsiblePDF({
    benefit
}) {
            ...
            <Page size={"A4"} style={pdfStyles.page}>
                ...
                <View style={pdfStyles.body}>
                    ...
                    <Text style={pdfStyles.text}>
                        ...
                        sou contemplado(a) de ações e serviços destinados a alunos e seu grupo familiar
                        , concedidos por esta instituição de ensino, conforme especificado anteriormente.
