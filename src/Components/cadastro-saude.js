...
export const CadastroSaude = ({ member }) => {
  ...
  const handleHealthChange = (e) => {
    ...
    if (e.target.multiple) {
      ...
      const value = target.type === 'checkbox' ? target.checked : target.value; // Correct handling for checkboxes
      setHealthInfo(prevState => ({
        ...prevState,
        [name]: value,
      }));
  ...
  async function handleRegisterHealth(e) {
    e.preventDefault()
    ...
    <div className="fill-box">
      <form id='survey-form'>
        <div class="survey-box">
          ...
          <br />
          <select name="diseases" multiple value={healthInfo.disease} onChange={handleHealthChange} required>
