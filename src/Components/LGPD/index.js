                    ...
                    <Portal id={"lgpd"}>
                        <Overlay>
                            <div className={styles.modal}>
                                < >
                                    <h2 style={{ textAlign: 'center' }}>DO TRATAMENTO E PROTEÇÃO DE DADOS PESSOAIS COM SEU CONSENTIMENTO</h2>

                                    <p>O tratamento de dados pessoais e sensíveis realizado pela <strong >CADASTRAQUI</strong> está de acordo com a legislação relativa à privacidade e à proteção de dados pessoais no
                                    ...
                                    <p>Ao realizar o processo de preenchimento do formulário eletrônico, bem como o upload da documentação exigida, os candidatos(as)/alunos(as) maiores de idade,
                                        os pais e/ou responsáveis legais de candidatos(as) ou alunos(as) já beneficiários autorizam a <strong >CADASTRAQUI</strong> acessar e a disponibilizar as informações à
                                    ...
                                    <p>A <strong >CADASTRAQUI</strong> fará o arquivo da documentação que instruiu o processo de seleção de candidatos (novos alunos ou renovação) para a concessão da gratuidade
                                    ...
                                    <p>A <strong >CADASTRAQUI</strong> firmou acordo de confidencialidade com seus colaboradores, prepostos, subcontratados e outros que possam ter acesso às informações sobre o dever
                                    ...
                                    <p>As informações constantes do formulário eletrônico, da análise técnica dos documentos apresentados e da análise da condição social dos alunos não
                                        selecionados serão submetidas ao processo de anonimização pela <strong >CADASTRAQUI</strong> e após o cumprimento do prazo legal de guarda e arquivo, as informações prestadas e
                                    ...
                                    <p>Para esclarecimentos adicionais, dúvidas ou sugestões, sobre o sistema <strong >CADASTRAQUI</strong>, solicita-se o envio pelo SAC disponível no sistema.</p>
                                </>
